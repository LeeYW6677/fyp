...
class ApprovedClaim extends StatefulWidget {
  final String selectedEvent;
  const ApprovedClaim({super.key, required this.selectedEvent});

  @override
  State<ApprovedClaim> createState() => _ApprovedClaimState();
}

class _ApprovedClaimState extends State<ApprovedClaim> {
